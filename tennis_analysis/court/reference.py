...
class CourtReference:
    """Project a standard tennis court model into image space and score line support."""

    def __init__(self):
        width = TENNIS_DOUBLES_WIDTH
        length = TENNIS_COURT_LENGTH
        singles_margin = (TENNIS_DOUBLES_WIDTH - TENNIS_SINGLES_WIDTH) / 2.0
        net_y = length / 2.0
        ...
        self.lines = [
            ...
            ((0, length), (0, 0), 1.35),
            ((singles_margin, 0), (singles_margin, length), 1.0),
            ((width - singles_margin, 0), (width - singles_margin, length), 1.0),
            ((0, net_y), (width, net_y), 1.15),
            ((singles_margin, service_top), (width - singles_margin, service_top), 0.9),
            ((singles_margin, service_bottom), (width - singles_margin, service_bottom), 0.9),
            ((center_x, service_top), (center_x, service_bottom), 0.75),
        ]
